...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-blue-400 via-orange-200 to-orange-300">
            ...
            <div className="flex space-x-8 border-b-2 border-white/50 mb-8">
              {[
                ...
                <button
                  ...
                  className={`pb-3 flex items-center gap-2 text-lg transition-all ${
                    activeTab === tab.id
